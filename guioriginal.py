...
class Getschedule(tk.Frame):
    ...
    def get_schedule(self, thelist):
        ...
        #print(theschedule)
        #self.print_schedule += "Subject" + " " + "Assignment" + " " + "Time Due" + " " + "Due Date" + " " + "Weight" + " " + "days left" + " " + "difficulty" + "\n\n"
        for items in theschedule:
            #print("\n")
            self.print_schedule += "\n" + "Subject" + " " + "Assignment" + " " + "Time Due" + " " + "Due Date" + " " + "Weight" + " " + "days left" + " " + "difficulty" + "\n\n"
            
            for i,rows in items.iterrows():
                #print(str(rows["Subject"]) + " " + str(rows["Assignment"]) + " " + str(rows["Time Due"]) + " " + str(rows["Due Date"])
                #      + " " + str(rows["Weight"]) + " " + self.days_only(str(rows["days left"])) + " " + str(rows["difficulty"])) 
                self.print_schedule += (str(rows["Subject"]) + " " + str(rows["Assignment"]) + " " + str(rows["Time Due"]) + " " + str(rows["Due Date"])
                      + " " + str(rows["Weight"]) + " " + self.days_only(str(rows["days left"])) + " " + str(rows["difficulty"])) + "\n"

                #print(i)
            
        #print(self.print_schedule)
